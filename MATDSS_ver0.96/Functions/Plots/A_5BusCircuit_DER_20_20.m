...
set (h, 'Units', 'normalized', 'Position', [0.25,0.25,0.2,0.4],'Visible', 'on');

CaseName = 'Step';
% CaseFolder = [currentDirectory(1:i_slash(end-1)) 'exports\5 Bus Circuit\' CaseName];     % initial subdirectory
CaseFolder = 'C:\Users\aldah\OneDrive - University of Waterloo\PhD UoW\2023\T & D Paper\Simulation Results\MATDSS_ver0.84\Exports\5 Bus Circuit\Step\New Setup\DER 20_20';     % initial subdirectory
...
leg = legend(P0ax,'','','','','','1CA','$\rm{2CA}_{config. 1}$', '$\rm{2CA}_{config. 2}$','interpreter','latex','NumColumns',1, 'Position', [0.683 0.825 0.2 0.05]);
...
figname = '5BusStepTrackingWithDisturbance';
...
set(P0zax, "XLim", [0.6 2.5], "YLim", [-220 -180])
hold off;


%%

figname = '5BusStepTrackingWithDisturbance_Power1';
...
% CaseFolder = [currentDirectory(1:i_slash(end-1)) 'exports\5 Bus Circuit\' CaseName];     % initial subdirectory
% CaseFolder = uigetdir("C:\Users\aldah\OneDrive - University of Waterloo\PhD UoW\2023\05 May\MATDSS_ver0.84\Exports");     % initial subdirectory
CaseFolder = 'C:\Users\aldah\OneDrive - University of Waterloo\PhD UoW\2023\T & D Paper\Simulation Results\MATDSS_ver0.84\Exports\5 Bus Circuit\Ramp\New Setup\DER 20_20';     % initial subdirectory
...
% Delta P0 Goal Limits
plot(P0ax,MATDSS.Time.Sim.TimeSpan-MATDSS.Time.Sim.ST,(MATDSS.ControlSignals.P0Set - MATDSS.ControlSignals.P0Set(1) - ContE(1))./1e3, '--', 'LineWidth', 1, 'Color',MyColors(end-1,:));
plot(P0ax,MATDSS.Time.Sim.TimeSpan-MATDSS.Time.Sim.ST,(MATDSS.ControlSignals.P0Set - MATDSS.ControlSignals.P0Set(1) + ContE(1))./1e3, '--', 'LineWidth', 1, 'Color',MyColors(end-1,:));
P0Legend = [P0Legend;""];
P0Legend = [P0Legend;""];
...
leg = legend(P0ax,'','','','1CA','$\rm{2CA}_{config. 1}$', '$\rm{2CA}_{config. 2}$','interpreter','latex','NumColumns',1, 'Position', [0.432 0.825 0.2 0.05]);
leg.ItemTokenSize = [10,15];
...
% set(h,'PaperUnits','inches','PaperPosition',MyPositionPlot)
%%
figname = '5BusRampTrackingWithDisturbance';
...
%%
% Prepare to disturbance effect - 2nd effect
set (h, 'Units', 'normalized', 'Position', [0.25,0.25,0.05,0.4],'Visible', 'on');
...
%%
figname = '5BusRampTrackingWithDisturbance_DisturbanceRight';
